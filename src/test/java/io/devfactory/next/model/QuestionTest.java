...
import static io.devfactory.next.model.AnswerTest.newAnswer;
import static io.devfactory.next.model.UserTest.newUser;
...
public class QuestionTest {
    ...
    public void canDelete_같은_사용자_답변() throws Exception {
        ...
        List<Answer> answers = Collections.singletonList(newAnswer(userId));
